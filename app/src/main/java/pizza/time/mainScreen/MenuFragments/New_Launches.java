...
public class New_Launches extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        ...
                        if(task.isSuccessful()){
                            ...
                            for(QueryDocumentSnapshot documentSnapshot : task.getResult()){
                                if (documentSnapshot.getString("type").equals("pizza_new"))
                                {
        ...
        return inflater.inflate(R.layout.fragment_new__launches, container, false);
    ...
    {
        RecyclerView menu_recycle= getActivity().findViewById(R.id.recycler_new_launches_pizza);
