...
import pizza.time.R;
import pizza.time.mainScreen.Menu;
...
public class Veg_Pizza extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        ...
                        if(task.isSuccessful()){
                            ...
                            for(QueryDocumentSnapshot documentSnapshot : task.getResult()){
                                if (documentSnapshot.getString("type").equals("pizza") || documentSnapshot.getString("type").equals("pizza_new"))
                                {
        ...
        return inflater.inflate(R.layout.fragment_veg__pizza, container, false);
    ...
    {
        RecyclerView menu_recycle= getActivity().findViewById(R.id.recycler_menu_Veg_pizza);
